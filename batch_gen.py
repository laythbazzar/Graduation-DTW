    ...
    def get_boundary(self, batch_size, pred, epoch_num, dist_method='euclidean'):
        ...
        for b, vid in enumerate(batch):
            ...
            for tuple in generated_timestamps:
                index_dtw = 0
                while index_dtw < (len(timestamp_frames_video1) - 1) and tuple[0] > timestamp_frames_video1[index_dtw][
                    0]:
                    index_dtw += 1
                if index_dtw == 0:
            ...
            if (epoch_num % 10 == 0):
                ...
                plt.savefig(
                    "/content/drive/MyDrive/visualise/" + vid.split('.txt')[0] + "_epoch" + str(epoch_num) + ".png")
